...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen pt-16 mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        <Image src={logoImg} alt="NWL Copa Logo" />
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight">
          Crie seu próprio bolão da copa e compartilhe entre amigos!
        </h1>

        <div className="mt-10 flex items-center gap-2">
          <Image src={usersAvatarExampleImg} alt="Avatares exemplo" />
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo a prévia da aplicação movel"
        quality={100}
      />
    </div>
  );
